...
def update_markers(event):
    ...
    # lift_offset = rospy.get_param('/lift_offset', 13)
    # lift_offset = rospy.get_param('/lift_offset', 11) #horizontal
    # drop_offset = rospy.get_param('/drop_offset', 4) #horizontal
    # lift_offset = rospy.get_param('/lift_offset', 16)#vertical
    # drop_offset = rospy.get_param('/drop_offset', 9) #vertical
